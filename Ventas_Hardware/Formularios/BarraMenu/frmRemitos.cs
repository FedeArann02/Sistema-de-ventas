...
namespace Ventas_Hardware
{
    public partial class frmRemitos : Form
    {
        ...
        private void cmbOpciones_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (cmbOpciones.SelectedIndex == 2)//Presupuesto
            {
                txtDocumentacionCliente.Enabled = false;
                lblDNICUIL_T.Enabled= false;
        ...
        private void crearCodigoRemito()
        {
            ...
            {
                txtCodigoRemito.Text = GenerarNumeroFactura(null);
            }
        }
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        int cantidadBD = int.Parse(dtArt.Rows[0]["Cantidad"].ToString()); //almacena la cantidad Real de ese articulo
                        ...
                        {
                            ArticulosSinStock += "● " + dtArt.Rows[0]["Descripcion"].ToString() + "\n"; //guarda el articulo en un mensaje de error
                        }
                    }
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                decimal.Parse(txtTotal.Text), DateTime.Today, dgvArticulos, txtCodigoRemito.Text, Id_usuario, txtCodigoPres.Text);
        ...
        private void imprimirRemito()
        {
            ...
            if (sfDialog.ShowDialog() == DialogResult.OK) //si presionamos OK
            {
                using (FileStream stream = new FileStream(sfDialog.FileName, FileMode.Create)) //acceso a archivos con filestream
                {
                    ...
                    MessageBox.Show("Remito guardado con éxito", "REMITO", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        public string GenerarNumeroFactura(string ultimoNumeroFactura)
        {
            ...
            // Retornar el nuevo número en formato AA-0000-0000 sin ceros adicionales
            string numeroConFormato = numeroActual.ToString("D8"); // D8 asegura 8 dígitos con ceros a la izquierda
            return $"{letras}-{numeroConFormato.Substring(0, 4)}-{numeroConFormato.Substring(4)}";
        }
